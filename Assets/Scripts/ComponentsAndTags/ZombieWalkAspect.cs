...
public readonly partial struct ZombieWalkAspect : IAspect
{
    ...
    public float WalkSpeed => _walkProperties.ValueRO.WalkSpeed;
    public float WalkAmplitude => _walkProperties.ValueRO.WalkAmplitude;
    public float WalkFrequency => _walkProperties.ValueRO.WalkFrequency;
    public float Heading => _heading.ValueRO.Value;
